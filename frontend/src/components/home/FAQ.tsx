...
const faqData = [
  ...
  },
  {
    ...
    answer: "Es gibt keine Einrichtungsgebühr, keine Fixkosten und kein Abo. Wir behalten lediglich eine geringe Provision pro verkauftem Gutschein ein – der Rest gehört Ihnen."
  },
  {
